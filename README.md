# Lone Wolf - Zombie Survival Game
...
### File Structure
This repository contains RAR files (approximately 100MB each) due to the large project size. Each file represents a significant portion of the game’s assets and codebase. Ensure you extract them before use.

### Requirements
- **Unity**: Version compatible with the project (e.g., Unity 2021 or later).
- **Storage**: Ensure sufficient disk space for the extracted files.
- **Platform**: Windows, macOS, or Linux for development and testing.
...
1. **Clone the Repository**:
   ```bash
   git clone https://github.com/yourusername/LoneWolf.git
